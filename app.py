...
# def home_page():
#     st.title("🔐 Secure Data Encryption System")  # Tumhari main heading same rakhi hai
...
#     if st.button("Login"):
#         if username in stored_data:
#             if stored_data[username]["passkey"] == hash_passkey(passkey):
...
#         if passkey:
#             if stored_data[st.session_state.username]["passkey"] == hash_passkey(passkey):
